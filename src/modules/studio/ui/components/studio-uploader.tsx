...
const UPLOADER_ID = "vide-uploader";
      ...
      <MuxUploaderDrop muxUploader={UPLOADER_ID} className="group/drop">
        <div slot="heading" className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col gap-2 text-center">
            <p className="text-sm">Drag and drop view files to upload</p>
            <p className="text-xs text-muted-foreground">
              Your vidoes will be public
            </p>
          </div>
        ...
        <MuxUploaderStatus muxUploader={UPLOADER_ID} className="text-xm" />
        <MuxUploaderProgress
        ...
        <MuxUploaderProgress type="bar" muxUploader={UPLOADER_ID} />
      </MuxUploaderDrop>
    </div>
  );
};
